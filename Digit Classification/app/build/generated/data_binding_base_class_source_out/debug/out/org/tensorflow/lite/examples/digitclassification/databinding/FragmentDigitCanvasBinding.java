...
public final class FragmentDigitCanvasBinding implements ViewBinding {
  ...
  private FragmentDigitCanvasBinding(@NonNull CoordinatorLayout rootView,
      @NonNull InfoBottomSheetBinding bottomSheetLayout, @NonNull Button btnClear,
  ...
  public static FragmentDigitCanvasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDigitCanvasBinding((CoordinatorLayout) rootView, binding_bottomSheetLayout,
          btnClear, digitCanvas, recyclerViewResults, tvInferenceTime, tvPredictedResults);
    }
